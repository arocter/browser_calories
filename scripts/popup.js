...
},{"./ComponentRegistry":3,"./ComponentRenderer":4,"metal":34,"metal-dom":9,"metal-events":19,"metal-state":29}],3:[function(require,module,exports){
'use strict';
...
},{"metal-events":19}],5:[function(require,module,exports){
'use strict';
...
},{"metal":34,"metal-events":19}],6:[function(require,module,exports){
'use strict';
...
},{"../Component":2,"../ComponentRegistry":3,"../ComponentRenderer":4,"../EventsCollector":5}],7:[function(require,module,exports){
'use strict';
...
var DomEventEmitterProxy = function (_EventEmitterProxy) {
	...
	function DomEventEmitterProxy() {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(DomEventEmitterProxy).apply(this, arguments));
	}
   ...
   */
		value: function addListener_(event, listener) {
			if (this.originEmitter_.addEventListener) {
				...
				return _get(Object.getPrototypeOf(DomEventEmitterProxy.prototype), 'addListener_', this).call(this, event, listener);
			}
		}
   ...
   */
		...
		value: function shouldProxyEvent_(event) {
			return _get(Object.getPrototypeOf(DomEventEmitterProxy.prototype), 'shouldProxyEvent_', this).call(this, event) && this.isSupportedDomEvent_(event);
		}
	}]);
...
},{"./dom":10,"metal-events":19}],8:[function(require,module,exports){
'use strict';
...
},{"metal-events":19}],9:[function(require,module,exports){
'use strict';
...
},{"../DomEventEmitterProxy":7,"../DomEventHandle":8,"../dom":10,"../events":11,"../features":12,"../globalEval":13,"../globalEvalStyles":14}],10:[function(require,module,exports){
'use strict';
...
exports.default = dom;
},{"./DomEventHandle":8,"metal":34}],11:[function(require,module,exports){
'use strict';
...
},{"./dom":10,"./features":12}],12:[function(require,module,exports){
'use strict';
...
},{"./dom":10,"metal":34}],13:[function(require,module,exports){
'use strict';
...
},{"./EventHandle":17,"metal":34}],16:[function(require,module,exports){
'use strict';
...
},{"metal":34}],17:[function(require,module,exports){
'use strict';
...
},{"./EventEmitter":15,"./EventEmitterProxy":16,"./EventHandle":17,"./EventHandler":18}],20:[function(require,module,exports){
'use strict';
...
},{"./incremental-dom":24,"metal":34}],21:[function(require,module,exports){
'use strict';
...
var IncrementalDomRenderer = function (_ComponentRenderer) {
  ...
  */
	...
	function IncrementalDomRenderer(comp) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(IncrementalDomRenderer).call(this, comp));

		comp.context = {};
		_this.changes_ = {};
		_this.eventsCollector_ = new _metalComponent.EventsCollector(comp);
  ...
  */
	...
	_createClass(IncrementalDomRenderer, [{
		key: 'addInlineListeners_',
		value: function addInlineListeners_(listeners) {
   ...
   */
		...
		key: 'handleDetached_',
		value: function handleDetached_() {
		...
		value: function handleInterceptedAttributesCall_(originalFn, element, name, value) {
			if (this.isListenerAttr_(name)) {
				...
				if (_metal.core.isFunction(value)) {
					_metalDom2.default.on(element, eventName, value);
				}
			}
   ...
   */
		...
		value: function handleRegularCall_(originalFn, tag, key, statics) {
   ...
   */
		...
		value: function hasChangedBesidesElement_() {
   ...
   * @protected
   */
		value: function isListenerAttr_(attr) {
...
},{"./IncrementalDomAop":20,"./children/IncrementalDomChildren":22,"./cleanup/IncrementalDomUnusedComponents":23,"./incremental-dom":24,"./utils/IncrementalDomUtils":25,"metal":34,"metal-component":6,"metal-dom":9}],22:[function(require,module,exports){
'use strict';
...
},{"../IncrementalDomAop":20,"../utils/IncrementalDomUtils":25,"metal":34}],23:[function(require,module,exports){
'use strict';
...
},{"metal":34}],24:[function(require,module,exports){
'use strict';
...
},{"metal":34}],26:[function(require,module,exports){
'use strict';
...
exports.default = JSX;
},{"./iDOMHelpers":28,"metal-incremental-dom":21}],27:[function(require,module,exports){
'use strict';
...
},{"./JSX":26,"metal-component":6}],28:[function(require,module,exports){
'use strict';
...
},{"metal-incremental-dom":21}],29:[function(require,module,exports){
'use strict';
...
var State = function (_EventEmitter) {
  ...
  */
   ...
   */
		...
		key: 'updateConfig_',
		value: function updateConfig_(values) {
...
},{"metal":34,"metal-events":19}],30:[function(require,module,exports){
'use strict';
...
var _budget = require('../data/budget');
...
var App = function (_JSXComponent) {
  ...
  _createClass(App, [{
    ...
    value: function getBudget() {
      ...
      chromeStorage.get(_budget2.default, function (data) {
        _this3.setState({
          budget: data
        });
      });
    ...
    value: function fetchURL() {
      ...
      var endpoint = 'https://www.googleapis.com/pagespeedonline/v2/runPagespeed?url=' + encodeURIComponent(this.url);

      if ("AIzaSyCQ_AcQHkCTX6jF-pHwVExxHUkGYakm77Y") {
        endpoint += '&key=' + "AIzaSyCQ_AcQHkCTX6jF-pHwVExxHUkGYakm77Y";
      }
    ...
    value: function render() {
      if (this.success && this.budget) {
        return IncrementalDOM.elementVoid(_result2.default, null, null, 'url', this.url, 'success', this.success, 'budget', this.budget);
      } else if (this.error) {
        return IncrementalDOM.elementVoid(_failure2.default, null, null, 'url', this.url, 'error', this.error);
      } else {
        return IncrementalDOM.elementVoid(_loader2.default, null, null, 'url', this.url);
      }
    }
  }]);
...
},{"../data/budget":37,"./failure":39,"./loader":40,"./result":42,"metal-jsx":27}],39:[function(require,module,exports){
'use strict';
...
var Failure = function (_JSXComponent) {
  _inherits(Failure, _JSXComponent);

  function Failure() {
    _classCallCheck(this, Failure);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(Failure).apply(this, arguments));
  }

  _createClass(Failure, [{
    key: 'render',
    value: function render() {
      var title = 'Error ' + this.config.error.code;

      if (this.config.error.code === 400) {
        title = 'URL can\'t be reached';
      }

      IncrementalDOM.elementOpen('div', null, null, 'class', 'status');
      IncrementalDOM.elementVoid('img', null, null, 'class', 'status-geek', 'src', '../images/error.png', 'alt', 'Geek');
      IncrementalDOM.elementVoid('img', null, null, 'class', 'status-rays', 'src', '../images/rays.png', 'alt', 'Rays');
      IncrementalDOM.elementOpen('div', null, null, 'class', 'status-msg');
      IncrementalDOM.elementOpen('p');
      iDOMHelpers.renderArbitrary(title);
      IncrementalDOM.elementClose('p');
      IncrementalDOM.elementOpen('p');
      IncrementalDOM.text('Try again on another tab or fill an ');
      IncrementalDOM.elementOpen('a', null, null, 'href', "https://github.com/zenorocha/browser-calories/issues/new?title=Error+" + this.config.error.code + "+for+" + encodeURIComponent(this.config.url) + "&body=%3E+" + encodeURIComponent(this.config.error.message), 'target', '_blank');
      IncrementalDOM.text('issue on GitHub');
...
},{"metal-jsx":27}],40:[function(require,module,exports){
"use strict";
...
var Loader = function (_JSXComponent) {
  _inherits(Loader, _JSXComponent);
  ...
  _createClass(Loader, [{
    ...
    value: function render() {
      IncrementalDOM.elementOpen("div", null, null, "class", "status");
      IncrementalDOM.elementVoid("img", null, null, "class", "status-geek", "src", "../images/loader.png", "alt", "Geek");
      IncrementalDOM.elementVoid("img", null, null, "class", "status-rays", "src", "../images/rays.png", "alt", "Rays");
      IncrementalDOM.elementOpen("div", null, null, "class", "status-msg");
      IncrementalDOM.elementOpen("p");
      IncrementalDOM.text("Measuring");
      IncrementalDOM.elementClose("p");
      IncrementalDOM.elementOpen("p");
      iDOMHelpers.renderArbitrary(this.config.url);
      IncrementalDOM.elementClose("p");
      IncrementalDOM.elementClose("div");
      return IncrementalDOM.elementClose("div");
    }
...
},{"metal-jsx":27}],41:[function(require,module,exports){
'use strict';
...
new _app2.default({}, document.querySelector('#wrapper'));

},{"./app":38}],42:[function(require,module,exports){
'use strict';
...
var _byteSize = require('byte-size');

var _byteSize2 = _interopRequireDefault(_byteSize);
...
var Result = function (_JSXComponent) {
  _inherits(Result, _JSXComponent);
  ...
  _createClass(Result, [{
    ...
    value: function toBytes(data) {
      ...
      for (var prop in data) {
        if (data.hasOwnProperty(prop)) {
          obj[prop] = (0, _byteSize2.default)(data[prop], { precision: 1 });
        }
      }
    ...
    key: 'toPercentage',
    value: function toPercentage(a, b) {
      var obj = {};
    ...
    key: 'isPositive',
    value: function isPositive(number) {
      var className = 'facts-percentage ';
    ...
    value: function openSettings() {
      ...
      var chromeRuntime = chrome.runtime || runtime;
    ...
    key: 'render',
    value: function render() {
      var cleanUrl = this.config.url.replace(/^http(s)?\:\/\/(www.)?/i, "").replace(/\/$/, "");
      var siteStats = this.toInt(this.config.success);
      var siteBytes = this.toBytes(siteStats);
      var budgetBytes = this.toBytes(this.config.budget);
      var dailyPercentage = this.toPercentage(siteStats, this.config.budget);

      IncrementalDOM.elementOpen('div', null, null, 'class', 'facts');
      IncrementalDOM.elementOpen('header', null, null, 'class', 'facts-header');
      IncrementalDOM.elementOpen('h1', null, null, 'class', 'facts-title');
      IncrementalDOM.text('Performance Facts');
      IncrementalDOM.elementClose('h1');
      IncrementalDOM.elementOpen('p');
      IncrementalDOM.text(' Serving Size 1 website ');
      IncrementalDOM.elementOpen('a', null, null, 'href', this.config.url, 'title', this.config.url, 'class', 'facts-url', 'target', '_blank');
      iDOMHelpers.renderArbitrary(cleanUrl);
      IncrementalDOM.elementClose('a');
      IncrementalDOM.elementClose('p');
      IncrementalDOM.elementClose('header');
      IncrementalDOM.elementOpen('table', null, null, 'class', 'facts-table facts-table-main');
      IncrementalDOM.elementOpen('thead');
      IncrementalDOM.elementOpen('tr', null, null, 'class', 'small-info');
      IncrementalDOM.elementOpen('th', null, null, 'colSpan', '2');
      IncrementalDOM.text(' Amount Per Serving ');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.text('% Per Load *');
      ...
      IncrementalDOM.elementOpen('th', null, null, 'colSpan', '2');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.text('HTML ');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(siteBytes.html);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.elementOpen('span', null, null, 'class', this.isPositive(dailyPercentage.html));
      iDOMHelpers.renderArbitrary(dailyPercentage.html);
      IncrementalDOM.text('%');
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementClose('td');
      ...
      IncrementalDOM.elementOpen('th', null, null, 'colSpan', '2');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.text('Images ');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(siteBytes.image);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.elementOpen('span', null, null, 'class', this.isPositive(dailyPercentage.image));
      iDOMHelpers.renderArbitrary(dailyPercentage.image);
      IncrementalDOM.text('%');
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementClose('td');
      ...
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(siteBytes.css);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.elementOpen('span', null, null, 'class', this.isPositive(dailyPercentage.css));
      iDOMHelpers.renderArbitrary(dailyPercentage.css);
      IncrementalDOM.text('%');
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementClose('td');
      ...
      IncrementalDOM.elementOpen('th', null, null, 'colSpan', '2');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.text('JavaScript ');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(siteBytes.js);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.elementOpen('span', null, null, 'class', this.isPositive(dailyPercentage.js));
      iDOMHelpers.renderArbitrary(dailyPercentage.js);
      IncrementalDOM.text('%');
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementClose('td');
      ...
      IncrementalDOM.elementOpen('th', null, null, 'colSpan', '2');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.text('Other ');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(siteBytes.other);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.elementOpen('span', null, null, 'class', this.isPositive(dailyPercentage.other));
      iDOMHelpers.renderArbitrary(dailyPercentage.other);
      IncrementalDOM.text('%');
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementClose('td');
      ...
      IncrementalDOM.elementOpen('th', null, null, 'colSpan', '2');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.text('Total Size ');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(siteBytes.total);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('b');
      IncrementalDOM.elementOpen('span', null, null, 'class', this.isPositive(dailyPercentage.total));
      iDOMHelpers.renderArbitrary(dailyPercentage.total);
      IncrementalDOM.text('%');
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('b');
      IncrementalDOM.elementClose('td');
      ...
      IncrementalDOM.elementOpen('p', null, null, 'class', 'facts-table-small-header small-info');
      IncrementalDOM.text('* Values are based on the ');
      IncrementalDOM.elementOpen('a', null, null, 'target', '_blank', 'href', 'http://httparchive.org/interesting.php?a=All&l=May%201%202016&s=Top100');
      IncrementalDOM.text('top 100 websites');
      IncrementalDOM.elementClose('a');
      IncrementalDOM.text(', but feel free to ');
      IncrementalDOM.elementOpen('a', null, null, 'data-onclick', this.openSettings);
      IncrementalDOM.text('change your performance budget');
      IncrementalDOM.elementClose('a');
      IncrementalDOM.text('. These values may be higher or lower depending on your needs:');
      IncrementalDOM.elementClose('p');
      IncrementalDOM.elementOpen('table', null, null, 'class', 'facts-table facts-table-small small-info');
      IncrementalDOM.elementOpen('tbody');
      IncrementalDOM.elementOpen('tr');
      IncrementalDOM.elementOpen('th', null, null, 'colSpan', '2');
      IncrementalDOM.text('HTML');
      IncrementalDOM.elementClose('th');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.text('Less than');
      IncrementalDOM.elementClose('td');
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(budgetBytes.html);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('td');
      IncrementalDOM.elementClose('tr');
      IncrementalDOM.elementOpen('tr');
      ...
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(budgetBytes.image);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('td');
      IncrementalDOM.elementClose('tr');
      IncrementalDOM.elementOpen('tr');
      ...
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(budgetBytes.css);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('td');
      IncrementalDOM.elementClose('tr');
      IncrementalDOM.elementOpen('tr');
      ...
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(budgetBytes.js);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('td');
      IncrementalDOM.elementClose('tr');
      IncrementalDOM.elementOpen('tr');
      ...
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(budgetBytes.other);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('td');
      IncrementalDOM.elementClose('tr');
      IncrementalDOM.elementOpen('tr');
      ...
      IncrementalDOM.elementOpen('td');
      IncrementalDOM.elementOpen('span');
      iDOMHelpers.renderArbitrary(budgetBytes.total);
      IncrementalDOM.elementClose('span');
      IncrementalDOM.elementClose('td');
      IncrementalDOM.elementClose('tr');
      IncrementalDOM.elementClose('tbody');
      IncrementalDOM.elementClose('table');
      IncrementalDOM.elementOpen('p', null, null, 'class', 'facts-table-small-footer small-info');
      IncrementalDOM.text(' This is an open source tool, contribute on ');
      IncrementalDOM.elementOpen('a', null, null, 'href', 'https://github.com/zenorocha/browser-calories', 'target', '_blank');
      IncrementalDOM.text('GitHub');
      IncrementalDOM.elementClose('a');
      IncrementalDOM.elementVoid('br');
      IncrementalDOM.text(' You can find tips to improve your website at ');
      IncrementalDOM.elementOpen('a', null, null, 'href', 'https://browserdiet.com/en/', 'target', '_blank');
      IncrementalDOM.text('browserdiet.com');
      IncrementalDOM.elementClose('a');
      IncrementalDOM.elementClose('p');
      return IncrementalDOM.elementClose('div');
    }
